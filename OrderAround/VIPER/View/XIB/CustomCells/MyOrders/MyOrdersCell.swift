...
extension MyOrdersCell {
    ...
    func setValues(values:OrderList) {
        ...
        self.labelShopName.text = values.shop?.name?.localize()
        self.labelShopAddress.text = values.shop?.address?.localize()
        ...
        self.labelDisputeStatus.text = values.dispute == DisputeStatus.CREATED.rawValue.localize() ? DisputeString.CREATED.rawValue.localize() : DisputeString.RESOLVE.rawValue.localize()
        let disputeImage = values.dispute == DisputeStatus.CREATED.rawValue.localize() ? "ic_dispute" : "ic_disputeresolved"
        self.imageDispute.image = UIImage(named: disputeImage)
        self.viewDispute.isHidden = values.dispute == DisputeStatus.NODISPUTE.rawValue.localize()
        self.labelDisputeStatus.textColor = values.dispute ==  DisputeStatus.CREATED.rawValue.localize() ? .red : UIColor.green
