...
class CartCheckOut: UITableViewCell {
    ...
    @IBOutlet weak var deliverSafeLabel: UILabel!
    @IBOutlet weak var useDeliveryButton: UIButton!
    ...
    func setCustomFont() {
        ...
        Common.setFont(to: deliverSafeLabel,isTitle: true,size: 14,fontType: .semiBold)
    }
    ...
    func localized() {
        ...
        deliverSafeLabel.text = APPLocalize.localizestring.deliverSafe.localize()
    }
}
