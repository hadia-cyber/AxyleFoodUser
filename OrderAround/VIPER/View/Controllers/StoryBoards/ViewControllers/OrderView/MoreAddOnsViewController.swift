    ...
    override func viewDidLoad() {
        ...
        if isFromFeatureProduct {
            ...
            if Double((featureProduct?.prices?.price)!) > (featureProduct?.prices?.orignal_price)! {
                priceLabel.text =   "\(Double((featureProduct?.prices?.price)!))" + (featureProduct?.prices?.currency)!
                offerPriceLabel.isHidden = false
                offerPriceLabel.text =    "\(Double((featureProduct?.prices?.orignal_price)!))" + (featureProduct?.prices?.currency)!
              ...
              offerPriceLabel.isHidden = true
                priceLabel.text =   "\(Double(featureProduct?.prices?.price ?? 0.0))" + (featureProduct?.prices?.currency)!
            ...
            if Double((product?.prices?.price)!) > (product?.prices?.orignal_price)! {
                priceLabel.text =  "\(Double((product?.prices?.price)!))" + (product?.prices?.currency)!
               offerPriceLabel.isHidden = false
                offerPriceLabel.text =  "\(Double((product?.prices?.orignal_price)!))" + (product?.prices?.currency)!
                print("offer price there")
                priceLabel.textColor = UIColor.lightGray
                let attributedString = NSMutableAttributedString(string: priceLabel.text!)
                ...
                priceLabel.textColor = UIColor.black
                offerPriceLabel.isHidden = true
                priceLabel.text =  "\(Double(product?.prices?.price ?? 0.0))" + (product?.prices?.currency)! 
                print("offer price not there")
