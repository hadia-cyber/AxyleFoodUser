...
class showDatePickerVC: UIViewController {
    ...
    @IBAction func onDoneAction(_ sender: Any) {
        ...
        delegate?.doneAction(isschedule: true, isscheduleDate: timeLabel.text ?? "", notes: self.notes, useWallet: self.useWallet, addressId: self.addressId,useDelivery: useDelivery)
