...
//        userText.text = APPLocalize.localizestring.Aunpasdevotre.localize()
//               userText2.text = APPLocalize.localizestring.premiérecommande.localize()
               userText.textColor = UIColor.primary
    ...
    func setCustomFont() {
         Common.setFont(to: userText, isTitle: true, size: 20, fontType: .regular)
...
//            userInfo = MakeJson.signUp(loginBy: .manual, email:email , password: password, userName: userName, phone: phoneNumber)
            var userDetailInfo = UserProfile()
...
//            Common.storeUserData(from: response)
            ...
            if login_by == "fb"  {
                ...
                if (UserDefaults.standard.value(forKey: Keys.list.socialLoginAccessToken) as? String) != nil {
                    ...
                    loginReqData.device_id = UUID().uuidString
                    loginReqData.device_type = .ios
                    loginReqData.device_token = deviceTokenString
                  ...
                  if (UserDefaults.standard.value(forKey: Keys.list.socialLoginAccessToken) as? String) != nil {
                    ...
                    loginRequestData.device_id = UUID().uuidString
                    loginRequestData.device_type = .ios
                    loginRequestData.device_token = deviceTokenString
