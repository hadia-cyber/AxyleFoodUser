...
extension ChangeLanguageViewController: UITableViewDelegate {
     ...
     func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let language = Language.allCases[indexPath.row]
           var languageObject = UserProfileDetails()
           languageObject.language = language
             self.presenter?.post(api: .userProfile, data: languageObject.toData()) // Sending selected language to backend
...
extension ChangeLanguageViewController: PostViewProtocol {
