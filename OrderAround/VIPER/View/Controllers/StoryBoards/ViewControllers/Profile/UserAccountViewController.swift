...
class UserAccountViewController: UIViewController {
    ...
    var menuImg = [#imageLiteral(resourceName: "ic_home_unselect"),#imageLiteral(resourceName: "fav-unselected"),#imageLiteral(resourceName: "payment"),#imageLiteral(resourceName: "order"),#imageLiteral(resourceName: "promotion"),#imageLiteral(resourceName: "password"),#imageLiteral(resourceName: "countrychange")] //#imageLiteral(resourceName: "payment")
