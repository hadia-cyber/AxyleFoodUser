...
//        self.UserText1.text = APPLocalize.localizestring.vosretuarents.localize()
//        self.UserText2.text = APPLocalize.localizestring.memeendroit.localize()
        self.UserText1.textColor = UIColor.primary
        self.UserText2.textColor = UIColor.primary
    ...
    private func constraints()
    {
        ...
        NSLayoutConstraint.activate([
            appleButton.topAnchor.constraint(equalTo: self.orLabel.topAnchor, constant: 10),
            appleButton.leadingAnchor.constraint(equalTo: self.appleSigninView.leadingAnchor, constant: 10),
            appleButton.trailingAnchor.constraint(equalTo: self.appleSigninView.trailingAnchor, constant: -10),
            appleButton.bottomAnchor.constraint(equalTo: self.orLabel.bottomAnchor, constant: 10),
//            appleButton.cornerRadius = 10
    ...
    AppleSignin.shared.initAppleSignin(scope: [.email, .fullName]) { (appleData) in
        ...
        loginReqData.login_by = .apple
        UserDefaults.standard.set(appleData.userId, forKey: Keys.list.socialLoginAccessToken)
...
extension SignInViewController: SocialLoginHelperDelegate {
    ...
    func didReceiveFacebookLoginUser(detail: FacebookUserDetail) {
        ...
        userInfo?.accessToken = AccessToken.current?.tokenString
