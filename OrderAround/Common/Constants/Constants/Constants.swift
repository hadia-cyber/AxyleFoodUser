...
struct APPLocalize {
    ...
    let vosretuarents = "localize.resturents"
    let memeendroit = "localize.mémeendroit"
    let Avecnospartenaires = "loalize.Avecnospartenaires,"
    let trouvezvotrebonheur = "localize.trouvezvotrebonheur"
    let Aunpasdevotre = "localize.Aunpasdevotre"
    let premiérecommande = "localize.premiérecommande"
    ...
    let PureVeg = "localize.Pureveg"
    let Offer = "localize.Offer"
    ...
    let walletBalance = "localize.walletBalance"
    let delete = "localize.delete"
    let card = "localize.card"
    let payOnline = "localize.payonine"
    let payuMoney = "localize.payumoney"
    ...
    let ProccedtoPay = "localize.proceedtopay"
    ...
    let ViewFulMenu = "localize.viewfullMenu"
    let customized = "localize.customized"
    
    let perItem = "localize.perItem"
    let item = "localize.item"
    let from = "localize.from"
    let deliverSafe = "localize.deliverSafe"
    let deliverfee = "localize.deliveryFee"
    ...
    let French = "localize.French"
       
    let disputeCreated = "localize.DISPUTECREATED"
...
enum DisputeString : String, Codable {
    ...
    case CREATED = "LITIGE CRÉÉ"
    case RESOLVE = "LITIGE RÉSOLU"
